...
def open_img():
    ...
    # Resize the image to fit within the frame dimensions
    img = img.resize((250, 220), Image.ANTIALIAS)
...
# Logo
Label(win, text='Hiding Message within Image', font='impack 30 bold', bg='black', fg='red').place(x=80, y=12)
